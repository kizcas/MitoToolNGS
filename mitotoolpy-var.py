...
def analyzeSeqInFile(species, inputFile, output, exeDir, region):
    ...
    if output != "stdout":
        ...
        print("Sample_Name\tHaplogroup\tMissing_Variants\tPrivate_Variants\tMissing_of_your_judgement\tVariants",
              end="\n", file=outFile)
    else:
        print("Sample_Name\tHaplogroup\tMissing_Variants\tPrivate_Variants\tMissing_of_your_judgement\tVariants",
              end="\n")
    ...
    for query in queryFile:
        ...
        querySetTmp = set(
            removeVariantForNonSelectedRegion(removeVariantForSomeRegion(species, queryList), regionBegin, regionEnd,
                                              species, region))
